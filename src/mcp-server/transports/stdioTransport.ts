...
import { ErrorHandler, logger, RequestContext } from '../../utils/index.js'; // Added RequestContext
...
export async function connectStdioTransport(server: McpServer, parentContext: RequestContext): Promise<void> {
  ...
  // operationContext inherits from parentContext and sets/overrides operation & transportType
  const operationContext = { ...parentContext, operation: 'connectStdioTransport', transportType: 'Stdio' };
